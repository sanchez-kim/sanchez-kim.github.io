...
export const dict = {
  ko: {
    ...
    experience: {
      ...
      items: [
        { org: '(주)인사이터', role: 'AI Engineer — AI Team', period: '2022.07 – 현재', bullets: [
          '생성형 AI·멀티모달·음성인식·LLM 등 11개 이상의 AI 프로젝트 수행.',
          'HyperCLOVA X 청소년 상담 챗봇을 수원시·화성시에 6개월+ 실증 운영.',
          'Whisper-large 파인튜닝으로 자폐 스펙트럼 음성인식 CER 10.4 달성(약 50% 개선).'
        ] },
    ...
    projects: {
      title: '회사 프로젝트',
      items: [
        { name: '고위험 고립위기 청소년 사전예방 시스템', org: '(주)인사이터', year: '2024', summary: '청소년 위기 사전 감지·상담 시스템. HyperCLOVA X 챗봇 + ELECTRA·sLLM 복합 위험 감지, 수원시·화성시 6개월+ 실증.', tags: ['HyperCLOVA X', 'RAG', 'ELECTRA', 'sLLM'] },
        { name: '자폐 스펙트럼 아동 특화 음성인식 모델', org: '(주)인사이터', year: '2024–2025', summary: 'Whisper-large 파인튜닝으로 자폐 음성인식 CER 10.4 달성(약 50% 개선). 임상 전문가와 검증.', tags: ['Whisper', 'DeepSpeed', 'GQA', 'LLM'] },
        { name: 'MBC Art 한복 디자인 생성 AI 시스템', org: '(주)인사이터', year: '2025', summary: 'SDXL+LoRA 한국 전통의상 생성 모델과 생성·편집·학습 통합 플랫폼. MBC Art 디자이너 실증.', tags: ['SDXL', 'LoRA', 'ComfyUI', 'FastAPI'] },
        { name: '배리어프리 멀티모달 캡셔닝 파이프라인', org: '(주)인사이터', year: '2024–2025', summary: '방송 영상 500시간 기반 VLM 이미지+오디오 멀티모달 캡셔닝 파이프라인. 장애 유형별 출력 최적화.', tags: ['VLM', 'Whisper', 'OpenCV', 'FFmpeg'] },
        { name: 'AI 기반 중고 가전제품 식별 서비스', org: '(주)인사이터', year: '2024', summary: 'YOLO 인식 + 이미지 유사도로 제조사·시세 자동 산정, Flutter 크로스플랫폼 출시. (기획~배포 리딩)', tags: ['YOLO', 'PyTorch', 'Flutter', 'FastAPI'] },
        { name: "아동 심리 HTP 자동 분석 '아맘때'", org: '(주)인사이터', year: '2023–2024', summary: 'YOLOv8 HTP(집-나무-사람) 그림 분석으로 아동 심리 상태 예측. 온프레미스 배포.', tags: ['YOLOv8', 'PyTorch', 'OpenCV', 'On-prem'] }
      ]
    },
    skills: {
      title: '기술 스택',
  ...
  en: {
    ...
    experience: {
      ...
      items: [
        { org: 'Insighter Inc.', role: 'AI Engineer — AI Team', period: 'Jul 2022 – Present', bullets: [
          'Led and contributed to 11+ AI projects across generative AI, multimodal, speech, and LLM services.',
          'Shipped a HyperCLOVA X youth-counseling chatbot, operated by Suwon & Hwaseong for 6+ months.',
          'Fine-tuned Whisper-large to CER 10.4 (~50% gain) for autism-spectrum speech recognition.'
        ] },
    ...
    projects: {
      title: 'Work Projects',
      items: [
        { name: 'At-Risk Youth Crisis Prevention System', org: 'Insighter Inc.', year: '2024', summary: 'Early-warning + counseling system. HyperCLOVA X chatbot with an ELECTRA·sLLM risk detector; 6+ months in production with two city governments.', tags: ['HyperCLOVA X', 'RAG', 'ELECTRA', 'sLLM'] },
        { name: 'Autism-Spectrum Speech Recognition Model', org: 'Insighter Inc.', year: '2024–2025', summary: 'Fine-tuned Whisper-large to CER 10.4 (~50% gain) for autism-spectrum speech, validated with clinicians.', tags: ['Whisper', 'DeepSpeed', 'GQA', 'LLM'] },
        { name: 'Korean Costume Generative AI for MBC Art', org: 'Insighter Inc.', year: '2025', summary: 'SDXL+LoRA Korean costume generation model with an integrated generate/edit/train platform; piloted with MBC Art.', tags: ['SDXL', 'LoRA', 'ComfyUI', 'FastAPI'] },
        { name: 'Barrier-Free Multimodal Captioning Pipeline', org: 'Insighter Inc.', year: '2024–2025', summary: 'VLM image+audio multimodal captioning pipeline over 500h of broadcast footage, tuned per disability type.', tags: ['VLM', 'Whisper', 'OpenCV', 'FFmpeg'] },
        { name: 'AI Used-Appliance Identification Service', org: 'Insighter Inc.', year: '2024', summary: 'YOLO + image similarity for automatic brand/price ID; shipped cross-platform on Flutter. (Led planning→deploy)', tags: ['YOLO', 'PyTorch', 'Flutter', 'FastAPI'] },
        { name: "Child Psychology HTP Auto-Analysis ('Amamttae')", org: 'Insighter Inc.', year: '2023–2024', summary: 'YOLOv8 HTP (House-Tree-Person) drawing analysis predicting child psychological state; on-prem deployment.', tags: ['YOLOv8', 'PyTorch', 'OpenCV', 'On-prem'] }
      ]
    },
    skills: {
      title: 'Skills',
